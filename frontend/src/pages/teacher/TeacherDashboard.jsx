      ...
      <div className="max-w-8xl mx-auto mt-4 px-6 py-12">
        ...
        <div className="bg-red mb-12">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            ...
            >
              <PlusCircle size={20} className="mr-2" strokeWidth={2.5} />
              Create New Test
            </Link>
          </div>
        </div>
        ...
        <div className="mb-12 grid grid-cols-1 gap-6 border-t border-gray-200 pt-6 md:grid-cols-3">
          <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-[0_1px_5px_rgba(0,0,0,0.25)]">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-black">Total Tests</p>
          ...
          <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-[0_1px_5px_rgba(0,0,0,0.25)]">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-black">Active Tests</p>
                <p className="text-2xl font-bold text-gray-900">
                    ...
                    <div className="px-6 pb-4">
                      <div className="space-y-3 rounded-lg bg-gray-50 p-4">
                        ...
                        <div className="flex items-center text-sm">
                          ...
                          <span className="w-12 text-gray-500">End:</span>
                          <span className="font-medium text-gray-900">
