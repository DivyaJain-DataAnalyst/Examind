...
import { PlusCircle, Edit, BarChart, Clock, Calendar, Users, BookOpen } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100">
          <div className="p-8 border-b border-gray-100">
            ...
            <p className="text-gray-600 mt-1">Manage and monitor all your tests</p>
          </div>
          ...
          <div className="p-8">
            {isLoading ? (
              <div className="text-center py-16">
                ...
                <p className="text-lg text-gray-600">Loading your tests...</p>
              </div>
            ) : tests.length === 0 ? (
              <div className="text-center py-16">
                  ...
                  >
                    ...
                    <div className="p-6 pb-4">
                      <div className="flex items-start justify-between mb-3">
                        ...
                        <span className={`px-2.5 py-1 rounded-lg text-xs font-medium ${getStatusColor(test.status)}`}>
                          {test.status}
                        </span>
                      </div>
                    ...
                    <div className="px-6 pb-4">
                      <div className="bg-gray-50 rounded-lg p-4 space-y-3">
                        <div className="flex items-center text-sm">
                          ...
                          <span className="text-gray-500 w-12">Start:</span>
                          <span className="text-gray-900 font-medium">{formatDate(test.startTime)}</span>
                        </div>
                        <div className="flex items-center text-sm">
                          <div className="w-2 h-2 bg-red-500 rounded-full mr-3"></div>
                          <span className="text-gray-500 w-12">End:</span>
                          <span className="text-gray-900 font-medium">{formatDate(test.endTime)}</span>
                        </div>
                      </div>
                    </div>
